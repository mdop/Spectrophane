...
def lithophane_config():
    return LithophaneConfig(resolution=(50,50),pixel_xy_dimension=(0.4,0.4),material_data=[{"name": "mat_a"}, {"name": "mat_b"}], builder_algorithm="voxel", export_backend_format="stl")
