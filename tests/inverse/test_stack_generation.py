...
def test_single_block_unordered(stack_generator, index, expected_thickness, expected_shape):
...
def test_single_block_multithickness_unordered(stack_generator):
...
def test_complete_stack_generation_unordered(stack_generator):
...
def test_generate_complete_mode(stack_generator):
